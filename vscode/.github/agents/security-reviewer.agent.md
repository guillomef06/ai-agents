...
hooks:
  ...
  # into the conversation before the agent reads any file.
  # Requires: Node.js + npm in PATH. Fails silently if package.json is absent.
  SessionStart:
    - type: command
      command: "node .github/hooks/scripts/audit-inject.js"
      windows: "node .github/hooks/scripts/audit-inject.js"
      timeout: 20
---
